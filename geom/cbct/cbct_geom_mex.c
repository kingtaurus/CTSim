...
static bool cbct_back_all
    ...
    if ( geom_type == BACK_PD ) {
        sof = cbct_back_pd(  nx, ny, nz, dx, dy, dz, offset_x, offset_y, offset_z, nu, nv, du, dv, offset_u, offset_v, sad, add, sdd, noviews, betas, couchz, detector_type, image, proj, map, true );
    } else if ( geom_type == BACK_HPD ) {
        sof = cbct_back_pd(  nx, ny, nz, dx, dy, dz, offset_x, offset_y, offset_z, nu, nv, du, dv, offset_u, offset_v, sad, add, sdd, noviews, betas, couchz, detector_type, image, proj, map, false );
    } else if (geom_type == BACK_DD ) {
        sof = cbct_back_dd(   nx, ny, nz, dx, dy, dz, offset_x, offset_y, offset_z, nu, nv, du, dv, offset_u, offset_v, sad, add, sdd, noviews, betas, couchz, detector_type, image, proj, map );
    } else if (geom_type == BACK_TF ) {
        sof = cbct_back_tf(   nx, ny, nz, dx, dy, dz, offset_x, offset_y, offset_z, nu, nv, du, dv, offset_u, offset_v, sad, add, sdd, noviews, betas, couchz, detector_type, image, proj, map);
    }  else if (geom_type == BACK_VAR ) {
        sof = cbct_back_var(   nx, ny, nz, dx, dy, dz, offset_x, offset_y, offset_z, nu, nv, du, dv, offset_u, offset_v, sad, add, sdd, noviews, betas, couchz, detector_type, image, proj, map, true  );
    }
