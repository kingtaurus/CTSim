function img = reconHelicalViewWeightedFDK( sino, geom, H, noViewsPerSlice, tiltedFilter )
% function img = reconHelicaViewlWeightedFDK( sino, geom, window, noViewsPerSlice, tiltedFilter, crop )
...
redundantWeights = computeHelicalWeights3D( geom, noViewsPerSlice );
