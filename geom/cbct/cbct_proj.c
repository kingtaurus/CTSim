...
bool cbct_proj_rd(
    ...
    // boudaries of the volume in x and y direction
    ...
    for (  ib = 0 ; ib < noviews; ib ++ ) {
        ...
        // boudaries of the volume in the z directions, there addition shifts by the couch in helical scans
        ...
        for ( iu = 0 ; iu < nu ; iu++ ) {
            ...
            // ray tracing step sizes in x and y directions
            ...
            if ( raydir_x > -1E-12 && raydir_x < 1E-12 ) {
                // the ray is along the x direction and outside the volume
            ...
            if ( raydir_y > -1E-12 && raydir_y < 1E-12  ) {
                ...
                // the ray is along the y direction and outside the volume
                ...
                // find the enter and leave point of ray in the y direction
            ...
            // the pixed index of the first pixel in the column iu 
            npixel = ib*nu*nv + iu*nv;
            
            // iterate over the rows
            for ( iv = 0; iv < nv ; iv ++ ){
                
                // ray step size in z direction 
