function [x, phis, rmsds] = reconPwlsLALMOs( y, w, geom, beta, pfun, itnlim, delta, numos, img0, imgOpt  )
...
fprintf('Reconstructing with single energy data using PWLS LALM OS... \n');
tRecon = tic;
