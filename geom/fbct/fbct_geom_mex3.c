...
static void fbct_geom_mex3_help(){
	mexPrintf("\n\
			  coming soon!\
			  \n");
}
...
*/
bool fbct_geom_mex3 (int nlhs, mxArray *plhs[], int nrhs,   mxArray *prhs[])
{
...
#if Debug1
	mexPrintf("fbct_geom_mex3() successed! \n");
#endif
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs,   mxArray *prhs[]){
	...
	if (!fbct_geom_mex3(nlhs, plhs, nrhs, prhs))
		mexErrMsgTxt("Error: fbct_geom_mex3() failed. \n");
	return;
