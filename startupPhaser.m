...
% parameters = 'parametersDualSources.ini';
 parameters = 'parametersPhaserCBCT.ini';
% parameters = 'parametersPhaserHelicalCT.ini';
% parameters = 'parametersPhaserAlignment.ini';
...
if dimemsions == 2
    ...
    sinosDirKeV = sprintf('../CTData/SinogramDataPhaser/sinoData-%s-%s-%imm-%imm-%ix%i-%ium/', ...
    ...
    sinosDirKeV = sprintf('../CTData/SinogramDataPhaser/sinoData-%s-%s-%imm-%imm-%ix%ix%i-%ium/', ...
        parameters(11:end-4), p.Phantom.materialsFileName, p.Geometries.SAD, p.Geometries.ADD,...
